...
(function ($, window, undefined) {
  ...
  $.fn.share = function (method) {
    ...
    var helpers = {
      channels: {
        facebook: {url: 'https://www.facebook.com/irishart.ie/=	|u|'},
        twitter: {url: 'https://twitter.com/TheNewPainting?ref_src=twsrc%5Etfw=|u|&text=|140|'},
  ...
  $.fn.share.defaults = {
    ...
    itemTemplate: function (props) {
      ...
      return '<li class="' + props.provider + '">' +
        '<a href="#" data-href="' + props.href + '" title="Visit our' + (props.provider === 'email' ? 'via ' : ' ') + providerName + ' ' + 'page' + '" class=' + props.itemTriggerClass + ' ' + props.provider + '">' +
